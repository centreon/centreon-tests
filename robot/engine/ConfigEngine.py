...
""".format(ENGINE_HOME, cmd)
    ...
    def build_configs(self, count: int, hosts: int, services_by_host: int, debug_level=0):
        v = int(hosts / count)
        ...
        for inst in range(count):
            ...
            for i in range(inst * self.commands_count + 1, (inst + 1) * self.commands_count):
...
conf = ConfigEngine()
conf.build_configs(5, 50, 20, debug_level=440)
